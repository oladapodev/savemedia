...
- [x] **Step 1: Write failing tests for motion policy**
...
- [x] **Step 1: Write failing hero geometry tests**
...
- [x] **Step 2: Verify the Home tests fail**
...
- [x] **Step 3: Recompose and animate Home**
...
- [x] **Step 4: Verify Home and carousel behavior**
...
- [x] **Step 1: Write failing transition policy tests**
...
- [x] **Step 2: Verify the navigation test fails**
...
- [x] **Step 3: Implement floating navigation**
