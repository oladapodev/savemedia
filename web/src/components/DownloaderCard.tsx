        ...
        <div className="p-5 sm:p-6">
          ...
          <div className="mt-4">
            <div className="flex items-center gap-2 text-sm text-gray-500">
              ...
              <span className="font-medium text-gray-700">Choose output quality</span>
              <span className="text-gray-400">before previewing</span>
            </div>
            ...
            <p className="mt-2 text-xs text-gray-400">
              Current default: {currentQuality?.label}{currentQuality?.tag ? ` (${currentQuality.tag})` : ''}
            </p>
          </div>
        </div>
