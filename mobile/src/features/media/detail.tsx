...
import { Button, ChoiceBar, Divider, Inline, MediaThumbnail, PageHeader, Screen, Stack, Surface, Text, space } from '../../ui';
...
export function MediaDetailScreen({ busy = false, error, item, mode, onBack, onDownload, onOpen, onQualityChange, onShare }: {
  ...
  return <Screen scroll><Stack gap="lg">
    ...
    <MediaThumbnail label={`${item.title} preview`} style={{ height: 230, width: '100%' }} uri={item.thumbnailUrl} />
